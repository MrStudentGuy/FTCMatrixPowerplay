...
@Autonomous
@Disabled
public class Safe_Low_Speed_Auto extends OpMode {
    ...
    Pose2d PARKING1 = new Pose2d(-60, -12, Math.toRadians(0));
    Pose2d PARKING2 = new Pose2d(-36, -13, Math.toRadians(0));
    Pose2d PARKING3 = new Pose2d(-12, -12, Math.toRadians(0));
