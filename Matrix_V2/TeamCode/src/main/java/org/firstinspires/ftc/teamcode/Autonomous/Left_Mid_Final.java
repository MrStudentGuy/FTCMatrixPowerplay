...
@Config
@Autonomous
public class Left_Mid_Final extends OpMode {
    ...
    final Pose2d droppingPosition0 = new Pose2d(-37.4, -12, Math.toRadians(180));       // Positions on the field to drop cone into pole
