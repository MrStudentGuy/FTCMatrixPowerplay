...
public class ZoomZoom extends LinearOpMode {
    ...
    final Pose2d pickingPosition = new Pose2d(-46.5, -12, Math.toRadians(180));
    OpenCvCamera camera;
    AprilTagDetectionPipeline aprilTagDetectionPipeline;
    final Pose2d PARKING1 = new Pose2d(-54, -12, Math.toRadians(90));
    final Pose2d PARKING2 = new Pose2d(-32, -13, Math.toRadians(90));
    final Pose2d PARKING3 = new Pose2d(-6, -12, Math.toRadians(90));
    // Lens intrinsics
    // UNITS ARE PIXELS
    ...
    final int PARKING_ZONE1 = 0;
    final int PARKING_ZONE2 = 1;
    final int PARKING_ZONE3 = 2;
    final int[] MATRIX_IDS = {3, 7, 9};
...
//                .waitSeconds(0.1)
                ...
                .waitSeconds(0.5)
                .addTemporalMarker(this::dropCone)
                .waitSeconds(0.1)
