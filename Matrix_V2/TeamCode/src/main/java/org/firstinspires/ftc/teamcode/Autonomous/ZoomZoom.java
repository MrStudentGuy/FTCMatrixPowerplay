...
public class ZoomZoom extends LinearOpMode {
    ...
    final Pose2d preloadDropPosition0 = new Pose2d(-45, -12, Math.toRadians(180));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence autonomousTrajectory = robot.trajectorySequenceBuilder(startPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(-0.1, ()->Servos.AlignBar.moveTo(0.15))
//                .waitSeconds(0.05)
...
//                .waitSeconds(0.1)
                ...
                .addTemporalMarker(()-> Servos.AlignBar.moveTo(0.55))
                .waitSeconds(0.4)
...
//                .waitSeconds(0.1)
                .addTemporalMarker(()->Servos.Wrist.goGripping())
                .addTemporalMarker(()-> Servos.AlignBar.goodAngle())
//                .addTemporalMarker(()-> Servos.AlignBar.dropPosition())
                ...
                .addTemporalMarker(()-> Servos.Slider.moveInside())
                .waitSeconds(0.2)
                .addTemporalMarker(()->Robot.targetDegree = -153)
                .lineToLinearHeading(preloadDropPosition)
                .UNSTABLE_addTemporalMarkerOffset(-0.4,()-> Servos.AlignBar.outside())
                .waitSeconds(0.6)
                .addTemporalMarker(()-> Servos.Slider.moveOutside())
...
//                .addTemporalMarker(()-> Servos.AlignBar.dropPosition())
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.25,()->lift.extendTo(lift.AUTO_POSITION[2], 1))
                .lineToLinearHeading(preloadDropPosition0)
                .UNSTABLE_addTemporalMarkerOffset(-0.1, ()-> {Servos.Gripper.openGripper();
                    Servos.Slider.moveHalfway();})
                .waitSeconds(0.25)
...
//                .addTemporalMarker(()-> Servos.AlignBar.dropPosition())
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.25,()->lift.extendTo(lift.AUTO_POSITION[1], 1))
                .lineToLinearHeading(preloadDropPosition0)
                .UNSTABLE_addTemporalMarkerOffset(-0.1, ()-> {Servos.Gripper.openGripper();
                    Servos.Slider.moveHalfway();})
                .waitSeconds(0.25)
...
//                .addTemporalMarker(()-> Servos.AlignBar.dropPosition())
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.25,()->lift.extendTo(lift.AUTO_POSITION[0], 1))
                .lineToLinearHeading(preloadDropPosition0)
                .UNSTABLE_addTemporalMarkerOffset(-0.1, ()-> {Servos.Gripper.openGripper();
                    Servos.Slider.moveHalfway();})
                .waitSeconds(0.25)
