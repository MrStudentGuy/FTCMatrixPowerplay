...
public class Left_Async_V2 extends OpMode {
    ...
    public void init() {
        ...
        startToCenter = robot.trajectorySequenceBuilder(startPose)
                ...
                .addTemporalMarker(0.5, ()->{Robot.targetDegree = -144;})
                .lineToLinearHeading(droppingPosition0)
                .UNSTABLE_addTemporalMarkerOffset(-1, ()->Servos.Wrist.goAutoTop())
                .UNSTABLE_addTemporalMarkerOffset(-0.5, ()-> {Servos.Slider.moveSlider(0.65);})
...
//                .waitSeconds(10)
                ...
                .lineToLinearHeading(droppingPosition0)
                .UNSTABLE_addTemporalMarkerOffset(-0.5, ()->Robot.targetDegree = -144)
                .waitSeconds(0.9)
                .addTemporalMarker(()-> Servos.Slider.moveSlider(0.65))
                .waitSeconds(0.5)
                .addTemporalMarker(()->Servos.Wrist.goGripping())
                .waitSeconds(0.1)
                .addTemporalMarker(()-> Servos.Gripper.openGripper())
