...
@Autonomous
@Disabled
public class RedLeftV3 extends LinearOpMode {
    Lift lift = null;
    Servos servos = null;
    Turret turret = null;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence startToDropPreload =drive.trajectorySequenceBuilder(startPose)
                .lineToConstantHeading(new Vector2d(-39.5, -63))
                ...
                .lineToConstantHeading(new Vector2d(-39.5, 0), SampleMecanumDrive.getVelocityConstraint(MAX_SPEED_AUTO, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
        ...
        TrajectorySequence pickCone5 = drive.trajectorySequenceBuilder(startToDropPreload.end())
                .lineToConstantHeading(new Vector2d(-39.5, -12), SampleMecanumDrive.getVelocityConstraint(MAX_SPEED_AUTO, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(()->turret.setDegree(90))
                .addTemporalMarker(()->lift.extendTo(lift.AUTO_POSITION[4], 0.8))
                .lineToConstantHeading(new Vector2d(-55.5, -12), SampleMecanumDrive.getVelocityConstraint(MAX_SPEED_AUTO, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
        ...
        TrajectorySequence dropCone5 = drive.trajectorySequenceBuilder(pickCone5.end())
                ...
                .addTemporalMarker(()->Servos.Wrist.goGripping())
                .lineToConstantHeading(new Vector2d(-26, -12.31), SampleMecanumDrive.getVelocityConstraint(MAX_SPEED_AUTO, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
//                .waitSeconds(0.01)
...
//                .waitSeconds(0.01)
//                .lineToConstantHeading(new Vector2d(-36, 0))
                .addTemporalMarker(()->drive.setWeightedDrivePower(new Pose2d(0.2, 0, 0)))
                .waitSeconds(0.05)
                .addTemporalMarker(()->drive.setWeightedDrivePower(new Pose2d(0, 0, 0)))
                .waitSeconds(0.15)
                .addTemporalMarker(()->Servos.Gripper.openGripper())
                .waitSeconds(0.05)
                .build();
...
//                .lineToConstantHeading(new Vector2d(-36, 0))
        ...
        TrajectorySequence overAll = drive.trajectorySequenceBuilder(startPoseOverall)
                .addTemporalMarker(()->Servos.Wrist.goGripping())
                .lineToConstantHeading(new Vector2d(-36, -63))
                .waitSeconds(0.01)
                .addTemporalMarker(()->turret.setDegree(-90))
                .addTemporalMarker(()->lift.extendToHighPole())
                .lineToConstantHeading(new Vector2d(-36, 0), SampleMecanumDrive.getVelocityConstraint(MAX_SPEED_AUTO, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .waitSeconds(0.5)
                .addTemporalMarker(()->Servos.Wrist.goGripping())
                .addTemporalMarker(()->Servos.Gripper.openGripper())
                .waitSeconds(0.1)
                .addTemporalMarker(()->turret.setDegree(90))
                .addTemporalMarker(()->lift.extendToGrippingPosition())
                ...
                .addTemporalMarker(()->Servos.Slider.moveInside())
                .lineToConstantHeading(new Vector2d(-24, -12), SampleMecanumDrive.getVelocityConstraint(MAX_SPEED_AUTO, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .waitSeconds(0.2)
                .addTemporalMarker(()->Servos.Gripper.openGripper())
                .waitSeconds(0.05)
                .addTemporalMarker(()->lift.extendToGrippingPosition())
                .UNSTABLE_addTemporalMarkerOffset(0.8, ()->{turret.setDegree(90);lift.extendToGrippingPosition();})
                .lineToConstantHeading(new Vector2d(-55.5, -12), SampleMecanumDrive.getVelocityConstraint(MAX_SPEED_AUTO, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .waitSeconds(0.5)
                .addTemporalMarker(()->Servos.Slider.moveSlider(0.25))
                .waitSeconds(0.2)
...
waitForStart();
    drive.followTrajectorySequence(overAll);
