...
public class AutoTester extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence autonomousTrajectory = robot.trajectorySequenceBuilder(startPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.05, ()->lift.extendTo(lift.POSITIONS[lift.MID_POLE], 1))
                .UNSTABLE_addTemporalMarkerOffset(0.05, ()->Robot.targetDegree = 144)
                .UNSTABLE_addTemporalMarkerOffset(0.1, ()-> Servos.Slider.moveSlider(0.25))
                .UNSTABLE_addTemporalMarkerOffset(0.6, ()-> Servos.AlignBar_2.goOutside())
                .UNSTABLE_addTemporalMarkerOffset(1, ()-> Servos.Wrist.goTop())
