...
@Autonomous
public class TestRightStandingMid extends LinearOpMode {

    OpenCvCamera camera;
    AprilTagDetectionPipeline aprilTagDetectionPipeline;
    static final double FEET_PER_METER = 3.28084;

    Pose2d PARKING1 = new Pose2d(8, -12, Math.toRadians(0));
    Pose2d PARKING1_INSIDE = new Pose2d(-58+72, -24, Math.toRadians(90));

    Pose2d PARKING2 = new Pose2d(34, -13, Math.toRadians(0));
    Pose2d PARKING2_INSIDE = new Pose2d(-34+72, -24, Math.toRadians(90));


    Pose2d PARKING3 = new Pose2d(58, -12, Math.toRadians(0));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence startToMid = robot.trajectorySequenceBuilder(startPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(-2, ()->Robot.targetDegree = -(AutoPositions.preloadTurretPosition-2))
...
//                .waitSeconds(0.01)
        ...
        TrajectorySequence pickToDrop = robot.trajectorySequenceBuilder(pickingPosition1)
                ...
                .addTemporalMarker(()->Robot.targetDegree = -(AutoPositions.highTurretPosition+3.8))
...
//                .setReversed(true)
                ...
                .lineToLinearHeading(PARKING1, SampleMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
...
//                .splineTo(new Vector2d(10.75, -31.07), Math.toRadians(-90.00))
        ...
        TrajectorySequence parking2Traj = robot.trajectorySequenceBuilder(dropPosition)
                ...
                .addTemporalMarker(()->robot.setTargetForSlider(0))
                .addTemporalMarker(()-> lift.extendTo(lift.POSITIONS[lift.LOW_POLE],1))
                .lineToLinearHeading(PARKING2, SampleMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
//                .lineToLinearHeading(PARKING2_INSIDE)
        ...
        TrajectorySequence parking3Traj = robot.trajectorySequenceBuilder(dropPosition)
                ...
                .addTemporalMarker(()-> lift.extendTo(lift.POSITIONS[lift.LOW_POLE],1))
//                .setReversed(true)
                .lineToLinearHeading(PARKING3, SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
