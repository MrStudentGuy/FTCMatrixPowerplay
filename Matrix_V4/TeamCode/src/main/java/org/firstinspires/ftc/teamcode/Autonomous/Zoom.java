...
//                .waitSeconds(0.)
                ...
                .UNSTABLE_addTemporalMarkerOffset(-0.5, ()->lift.extendTo(lift.POSITIONS[lift.HIGH_POLE], 1))
                .UNSTABLE_addTemporalMarkerOffset(-1.1, ()-> Servos.Wrist.goAutoTop())
                .UNSTABLE_addTemporalMarkerOffset(-0.8, ()-> Servos.AlignBar.autoOutsideHigh())
                .UNSTABLE_addTemporalMarkerOffset(-0.3, ()-> Servos.Slider.moveSlider(0.6))
//                .addTemporalMarker(()-> Servos.Slider.moveSlider(0.6))
                ...
                .UNSTABLE_addTemporalMarkerOffset(-0.7,()->lift.extendTo(lift.AUTO_POSITION[3], 1))
                .UNSTABLE_addTemporalMarkerOffset(-0.2,()-> Servos.Gripper.openGripper())
                .addTemporalMarker(()-> Servos.Slider.moveOutside())
                .waitSeconds(0.3)
...
//                .addTemporalMarker(()-> Servos.Slider.moveSlider(0.6))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.1,()->{Servos.Gripper.closeGripper();
                    Servos.AlignBar.inside();})
                .lineToLinearHeading(pickingPosition1)
                .UNSTABLE_addTemporalMarkerOffset(-0.7,()->lift.extendTo(lift.AUTO_POSITION[2], 1))
                .UNSTABLE_addTemporalMarkerOffset(-0.2,()-> Servos.Gripper.openGripper())
                .addTemporalMarker(()-> Servos.Slider.moveOutside())
                .waitSeconds(0.3)
...
//                .addTemporalMarker(()-> Servos.Slider.moveSlider(0.6))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.1,()->{Servos.Gripper.closeGripper();
                    Servos.AlignBar.inside();})
                .lineToLinearHeading(pickingPosition1)
                .UNSTABLE_addTemporalMarkerOffset(-0.7,()->lift.extendTo(lift.AUTO_POSITION[1], 1))
                .UNSTABLE_addTemporalMarkerOffset(-0.2,()-> Servos.Gripper.openGripper())
                .addTemporalMarker(()-> Servos.Slider.moveOutside())
                .waitSeconds(0.3)
...
//                .addTemporalMarker(()-> Servos.Slider.moveSlider(0.6))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.1,()->{Servos.Gripper.closeGripper();
                    Servos.AlignBar.inside();})
                .lineToLinearHeading(pickingPosition1)
                .UNSTABLE_addTemporalMarkerOffset(-0.7,()->lift.extendTo(lift.AUTO_POSITION[0], 1))
                .UNSTABLE_addTemporalMarkerOffset(-0.2,()-> Servos.Gripper.openGripper())
                .addTemporalMarker(()-> Servos.Slider.moveOutside())
                .waitSeconds(0.3)
