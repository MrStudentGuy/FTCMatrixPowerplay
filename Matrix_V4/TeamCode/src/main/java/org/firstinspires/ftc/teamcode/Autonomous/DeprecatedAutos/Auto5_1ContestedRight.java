...
@Autonomous
public class Auto5_1ContestedRight extends LinearOpMode {
    ...
    Pose2d PARKING1 = new Pose2d(-56.0001+74, -12, Math.toRadians(90));
    Pose2d PARKING2 = new Pose2d(-34+74, -13, Math.toRadians(90));
    Pose2d PARKING3 = new Pose2d(-10+74, -12, Math.toRadians(90));
    ...
    final Pose2d pickingPosition1 = new Pose2d(44.5, -12, Math.toRadians(0));
    final Pose2d pickingPosition2 = new Pose2d(45.5, -12, Math.toRadians(0));
    final Pose2d pickingPosition3 = new Pose2d(46, -12, Math.toRadians(0));
    final Pose2d pickingPosition4 = new Pose2d(46.5, -12, Math.toRadians(0));

    final Pose2d midDropPosition = new Pose2d(40, -12, Math.toRadians(0));
    final Pose2d centerHighPosition = new Pose2d(midDropPosition.getX() - 24, -12, Math.toRadians(0));
