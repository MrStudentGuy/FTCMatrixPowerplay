...
public class BackupLeft extends LinearOpMode {
    ...
    Pose2d PARKING1 = new Pose2d(-60, -62+24, Math.toRadians(180));
    Pose2d PARKING1_INSIDE = new Pose2d(-58, -24, Math.toRadians(90));

    Pose2d PARKING2 = new Pose2d(-36, -62+24, Math.toRadians(180));
    Pose2d PARKING2_INSIDE = new Pose2d(-34, -24, Math.toRadians(90));


    Pose2d PARKING3 = new Pose2d(-12, -62+24, Math.toRadians(180));
    ...
    final Pose2d leftPoint2 = new Pose2d(-31.8+20, -62+24, Math.toRadians(180));
    final Pose2d leftPoint1 = new Pose2d(-31.8+20, -62, Math.toRadians(180));
